                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-600 dark:text-gray-400 leading-relaxed">
                            Create point-in-time snapshots, upload backups (.sqlite or .sql), download archives, or restore the system state instantly.
                        </p>
                        <div wire:loading wire:target="backupFile,handleUploadBackup" class="text-xs font-bold text-cyan-500 animate-pulse flex items-center gap-1.5 mt-2">
                            ...
                            Uploading and processing backup...
                        </div>
                    </div>
                </div>
                <div class="flex items-center gap-3 shrink-0">
                    <label class="cursor-pointer px-4 py-2.5 bg-white dark:bg-white/10 text-gray-700 dark:text-gray-200 border border-gray-300 dark:border-white/15 rounded-xl text-xs font-bold hover:bg-gray-50 dark:hover:bg-white/15 transition flex items-center gap-2 shadow-sm">
                        ...
                        <input type="file" wire:model="backupFile" wire:change="handleUploadBackup" accept=".sqlite,.sql" class="hidden">
                    </label>

                    <button type="button" wire:click="handleCreateBackup" wire:loading.attr="disabled"
                        class="px-5 py-2.5 bg-emerald-600 text-white rounded-xl text-xs font-bold hover:bg-emerald-700 transition flex items-center gap-2 shadow-lg shadow-emerald-900/30 disabled:opacity-50">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 4v16m8-8H4"/></svg>
                        <span wire:loading.remove wire:target="handleCreateBackup">Create Snapshot Now</span>
                        <span wire:loading wire:target="handleCreateBackup">Creating...</span>
                    </button>
                </div>
            </div>
