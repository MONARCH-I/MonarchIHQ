<x-main-layout
    ...
    <section class="relative pt-32 pb-16 px-6 overflow-hidden" style="background: var(--bg-primary);">
        ...
        <div class="max-w-[860px] mx-auto text-center relative z-10 reveal">
            <span class="text-xs font-bold tracking-[0.25em] text-[#9c051d] uppercase mb-4 inline-block">Compliance & Attribution</span>
        ...
        <div class="max-w-[860px] mx-auto space-y-12 reveal">
            ...
            <div class="p-8 md:p-10 rounded-3xl" style="background: var(--bg-card); border: 1px solid var(--border-color);">
                ...
                <div class="p-5 rounded-2xl" style="background: var(--bg-secondary); border: 1px solid var(--border-color);">
                    <p class="text-sm font-mono text-[#9c051d]">Copyright &copy; {{ date('Y') }} MonarchI HQ & Contributing Authors.</p>
            ...
            <div class="p-8 md:p-10 rounded-3xl" style="background: var(--bg-card); border: 1px solid var(--border-color);">
                ...
                <div class="p-4 rounded-xl inline-block" style="background: rgba(156,5,29,0.08); border: 1px solid rgba(156,5,29,0.2);">
                    <p class="text-sm font-mono text-[#9c051d]">licensing@monarchihq.com</p>
