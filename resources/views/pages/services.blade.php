<x-main-layout
    ...
    <section class="relative pt-32 pb-20 px-6 min-h-[60vh] flex items-center justify-center overflow-hidden" style="background: var(--bg-primary);">
        ...
        <div class="max-w-[1000px] mx-auto text-center relative z-10 reveal">
            <h1 class="text-xs font-bold tracking-[0.25em] text-[#9c051d] uppercase mb-6">Our Expertise</h1>
            <h2 class="text-5xl md:text-7xl font-bold tracking-tight mb-8 leading-tight" style="color: var(--text-primary);">
                Engineering the <br>
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#9c051d] to-[#8ebcf2]">Future of Business.</span>
            </h2>
        ...
        <div class="max-w-[1200px] mx-auto flex flex-col gap-32">
            ...
            <div class="flex flex-col md:flex-row items-center gap-12 lg:gap-24 reveal">
                <div class="w-full md:w-1/2 order-2 md:order-1">
                    <div class="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-[#9c051d]/10 text-[#9c051d] mb-6">
                    ...
                    <ul class="space-y-3 mb-8" style="color: var(--text-secondary);">
                        <li class="flex items-center gap-3"><svg class="w-5 h-5 text-[#9c051d]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Multi-tenant cloud architectures</li>
                        <li class="flex items-center gap-3"><svg class="w-5 h-5 text-[#9c051d]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Real-time data synchronization</li>
                        <li class="flex items-center gap-3"><svg class="w-5 h-5 text-[#9c051d]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Secure API integrations</li>
                    </ul>
                </div>
            ...
            <div class="flex flex-col md:flex-row items-center gap-12 lg:gap-24 reveal delay-100">
                ...
                <div class="w-full md:w-1/2">
                    ...
                    <ul class="space-y-3 mb-8" style="color: var(--text-secondary);">
                        <li class="flex items-center gap-3"><svg class="w-5 h-5 text-[#9c051d]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Offline machine learning inference</li>
                        <li class="flex items-center gap-3"><svg class="w-5 h-5 text-[#9c051d]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Computer vision at the edge</li>
                        <li class="flex items-center gap-3"><svg class="w-5 h-5 text-[#9c051d]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Ultra-low power consumption</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row items-center gap-12 lg:gap-24 reveal delay-100">
                <div class="w-full md:w-1/2 order-2 md:order-1">
                    ...
                    <ul class="space-y-3 mb-8" style="color: var(--text-secondary);">
                        <li class="flex items-center gap-3"><svg class="w-5 h-5 text-[#9c051d]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> AI-driven process mapping</li>
                        <li class="flex items-center gap-3"><svg class="w-5 h-5 text-[#9c051d]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Automated data extraction &amp; routing</li>
                        <li class="flex items-center gap-3"><svg class="w-5 h-5 text-[#9c051d]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Legacy system integration</li>
                    </ul>
                </div>
                <div class="w-full md:w-1/2 order-1 md:order-2">
                    <div class="relative rounded-3xl overflow-hidden shadow-2xl group h-[400px]">
            ...
            <div class="flex flex-col md:flex-row items-center gap-12 lg:gap-24 reveal delay-100">
                ...
                <div class="w-full md:w-1/2">
                    ...
                    <ul class="space-y-3 mb-8" style="color: var(--text-secondary);">
                        <li class="flex items-center gap-3"><svg class="w-5 h-5 text-[#9c051d]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> IoT sensor networks</li>
                        <li class="flex items-center gap-3"><svg class="w-5 h-5 text-[#9c051d]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Embedded firmware development</li>
                        <li class="flex items-center gap-3"><svg class="w-5 h-5 text-[#9c051d]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Real-time telemetry dashboards</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row items-center gap-12 lg:gap-24 reveal delay-100">
                <div class="w-full md:w-1/2 order-2 md:order-1">
                    ...
                    <ul class="space-y-3 mb-8" style="color: var(--text-secondary);">
                        <li class="flex items-center gap-3"><svg class="w-5 h-5 text-[#9c051d]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Native mobile applications</li>
                        <li class="flex items-center gap-3"><svg class="w-5 h-5 text-[#9c051d]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> High-performance web apps (SPA/PWA)</li>
                        <li class="flex items-center gap-3"><svg class="w-5 h-5 text-[#9c051d]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Enterprise desktop software</li>
                    </ul>
                </div>
                <div class="w-full md:w-1/2 order-1 md:order-2">
    ...
    <section class="py-24 px-6 z-10 border-t" style="border-color: var(--border-color); background: var(--bg-primary);">
        <div class="max-w-[1200px] mx-auto reveal">
            <div class="text-center mb-16">
                <h2 class="text-xs font-bold tracking-[0.2em] text-[#9c051d] uppercase mb-3">Our Methodology</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="p-8 rounded-3xl relative overflow-hidden group" style="background: var(--bg-card); border: 1px solid var(--border-color);">
                    <div class="text-5xl font-bold text-[#9c051d]/20 mb-4 transition-transform group-hover:scale-110 group-hover:-translate-y-2 group-hover:text-[#9c051d]/30 duration-500">01</div>
                ...
                <!-- Step 2 -->
                <div class="p-8 rounded-3xl relative overflow-hidden group" style="background: var(--bg-card); border: 1px solid var(--border-color);">
                    <div class="text-5xl font-bold text-[#9c051d]/20 mb-4 transition-transform group-hover:scale-110 group-hover:-translate-y-2 group-hover:text-[#9c051d]/30 duration-500">02</div>
                ...
                <!-- Step 3 -->
                <div class="p-8 rounded-3xl relative overflow-hidden group" style="background: var(--bg-card); border: 1px solid var(--border-color);">
                    <div class="text-5xl font-bold text-[#9c051d]/20 mb-4 transition-transform group-hover:scale-110 group-hover:-translate-y-2 group-hover:text-[#9c051d]/30 duration-500">03</div>
                ...
                <!-- Step 4 -->
                <div class="p-8 rounded-3xl relative overflow-hidden group" style="background: var(--bg-card); border: 1px solid var(--border-color);">
                    <div class="text-5xl font-bold text-[#9c051d]/20 mb-4 transition-transform group-hover:scale-110 group-hover:-translate-y-2 group-hover:text-[#9c051d]/30 duration-500">04</div>
    ...
    <section class="py-24 px-6 border-t relative overflow-hidden" style="border-color: var(--border-color); background: var(--bg-section);">
        <div class="absolute inset-0 pointer-events-none">
            <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full opacity-10 blur-[120px]" style="background: radial-gradient(circle, #9c051d, transparent 60%);"></div>
        </div>
        ...
        <div class="max-w-[800px] mx-auto text-center relative z-10 reveal">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="/contact" class="px-8 py-4 rounded-full bg-[#9c051d] text-white font-medium hover:bg-[#9c051d] transition shadow-lg shadow-[#9c051d]/30">Start a Project</a>
