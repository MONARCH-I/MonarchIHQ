    ...
    <div class="mai-root-wrapper" id="maiApp">
                ...
                <div class="mai-center-brand">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="mai-model-chip">
                            ...
                            <span class="font-small">{{ $geminiModel ?? 'gemini-2.5-flash' }}</span>
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="mai-workspace-layout">
            ...
            <main class="mai-chat-canvas">
                ...
                {{-- ── PINNED FLEX DOCK (Input Dock never overlaps or cuts off) ── --}}
                <div class="mai-dock-container">
        ...
        {{-- ── STYLES: FIXED VIEWPORT & CHAT CANVAS SCROLLING ── --}}
        <style>
            /* ── Layout Overrides to prevent outer page scroll and viewport overflows ── */
            ...
            .fi-layout:has(.mai-root-wrapper) {
            ...
            /* Completely collapse and reset Filament's internal page wrappers, sections, and grids */
            .fi-page:has(.mai-root-wrapper),
            .fi-page:has(.mai-root-wrapper) > section,
            .fi-page:has(.mai-root-wrapper) > section > div,
            .fi-page:has(.mai-root-wrapper) > section > div > div {
                gap: 0 !important;
                padding: 0 !important;
                margin: 0 !important;
                flex: 1 1 0% !important;
            ...
            .fi-page:has(.mai-root-wrapper) > section > header {
                display: none !important;
            }

            /* Root Container: Flexibly occupies 100% of the available viewport area */
            .mai-root-wrapper {
                position: relative;
                width: 100%;
                flex: 1 1 0% !important;
            ...
            /* Central Chat Canvas (Structural Fix) */
            .mai-chat-canvas {
                position: relative;
                flex: 1 1 0%;
                display: flex;
            ...
            /* Messages Container: Scrolls cleanly within fixed viewport */
            ...
            .mai-messages-container::-webkit-scrollbar {
                width: 6px;
            }
            .mai-messages-container::-webkit-scrollbar-track {
                background: transparent;
            }
            .mai-messages-container::-webkit-scrollbar-thumb {
                background: rgba(255, 255, 255, 0.12);
                border-radius: 99px;
            }
            .mai-messages-container::-webkit-scrollbar-thumb:hover {
            ...
            /* ── FIXED PINNED DOCK (Flex Flow instead of Absolute Floating) ── */
            .mai-dock-container {
                position: relative;
                z-index: 25;
                width: 100%;
                padding: 8px 16px 12px;
                background: linear-gradient(180deg, transparent 0%, rgba(9, 10, 16, 0.95) 24%);
                backdrop-filter: blur(12px);
                -webkit-backdrop-filter: blur(12px);
                flex-shrink: 0;
                display: flex;
            ...
            .mai-dock-capsule {
                ...
                border-radius: 16px !important; /* Defined rounded corners */
                padding: 8px 12px 8px !important;
                box-shadow: 0 16px 40px -8px rgba(0, 0, 0, 0.7), inset 0 1px 1px 0 rgba(255, 255, 255, 0.18) !important;
                transition: all 0.22s cubic-bezier(0.16, 1, 0.3, 1) !important;
            }
            .mai-dock-capsule:focus-within {
                border-color: rgba(56, 189, 248, 0.45) !important;
                border-top-color: rgba(56, 189, 248, 0.75) !important;
                box-shadow: 0 20px 54px -6px rgba(56, 189, 248, 0.22), inset 0 1px 2px 0 rgba(255, 255, 255, 0.3) !important;
            }
            .mai-dock-top-row {
                display: flex;
                align-items: center;
            ...
            .mai-input-row {
                ...
                border-radius: 12px !important; /* Defined rounded corners */
                padding: 6px 8px 6px 12px !important;
                box-shadow: inset 0 2px 4px rgba(0, 0, 0, 0.25) !important;
                transition: all 0.2s cubic-bezier(0.16, 1, 0.3, 1) !important;
            }
            .mai-dock-capsule:focus-within .mai-input-row {
                background: rgba(255, 255, 255, 0.055) !important;
                border-color: rgba(56, 189, 248, 0.35) !important;
                border-top-color: rgba(56, 189, 248, 0.6) !important;
                box-shadow: inset 0 2px 4px rgba(0, 0, 0, 0.3), 0 0 16px rgba(56, 189, 248, 0.14) !important;
            }
            .mai-root-wrapper textarea,
            .mai-root-wrapper textarea:focus,
            .mai-root-wrapper textarea:active,
            #maiUserInput,
            #maiUserInput:focus,
            #maiUserInput:active {
                flex: 1 !important;
        ...
        {{-- ── JAVASCRIPT: GEMINI CHAT ENGINE & RESIZE HANDLER ── --}}
        <script>
        (function () {
            'use strict';
                ...
                .then(result => {
                    ...
                    if (result.status !== 200 || !result.data.ok) {
                        const errMsg = (result.data && (result.data.error || result.data.message))
                            ...
                            : `Gemini inference error (${result.status}). Please verify your configuration.`;
