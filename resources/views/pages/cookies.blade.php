    ...
    <section class="py-16 px-6 z-10 relative border-t" style="border-color: var(--border-color); background: var(--bg-section);">
        <div class="max-w-[860px] mx-auto space-y-12 reveal">
            ...
            <div class="p-8 md:p-10 rounded-3xl" style="background: var(--bg-card); border: 1px solid var(--border-color);">
                <h2 class="text-2xl font-semibold mb-4" style="color: var(--text-primary);">1. What Are Cookies?</h2>
                <p class="text-sm md:text-base leading-relaxed" style="color: var(--text-secondary);">
                    Cookies and secure session tokens are small data files stored in your web browser. They allow our systems to recognize your authenticated session, remember your interface theme (Day vs. Night mode), protect against CSRF attacks, and ensure lightning-fast navigation.
                </p>
            </div>
            ...
            <div class="p-8 md:p-10 rounded-3xl" style="background: var(--bg-card); border: 1px solid var(--border-color);">
                <h2 class="text-2xl font-semibold mb-4" style="color: var(--text-primary);">3. Managing Cookie Settings</h2>
