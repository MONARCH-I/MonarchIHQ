<x-main-layout
    ...
    <section class="relative pt-32 pb-16 px-6 overflow-hidden" style="background: var(--bg-primary);">
        ...
        <div class="max-w-[860px] mx-auto text-center relative z-10 reveal">
            <span class="text-xs font-bold tracking-[0.25em] text-[#9c051d] uppercase mb-4 inline-block">Ecosystem & People</span>
        ...
        <div class="max-w-[860px] mx-auto space-y-12 reveal">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="p-8 rounded-3xl" style="background: var(--bg-card); border: 1px solid var(--border-color);">
                    <div class="w-12 h-12 rounded-2xl bg-[#9c051d]/10 text-[#9c051d] flex items-center justify-center mb-6">
                    ...
                    <a href="https://github.com/MONARCH-I" target="_blank" class="text-xs font-semibold text-[#9c051d] hover:underline flex items-center gap-1">
                ...
                <div class="p-8 rounded-3xl" style="background: var(--bg-card); border: 1px solid var(--border-color);">
                    ...
                    <a href="{{ route('contact.index') }}" class="text-xs font-semibold text-[#9c051d] hover:underline flex items-center gap-1">
